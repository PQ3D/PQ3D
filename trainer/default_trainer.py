...
class DefaultTrainer(BaseTrainer):
    ...
    def eval_step(self, epoch):
        ...
        # all evaluators will return self.eval_dict, without deepcopy, this 'best_metric' will add
        # unseen keys to the self.eval_dict for each evaluator
        results = copy.deepcopy(results)
        results["best_metric"] = self.best_metric
